...
export default function ProductCard({
  ...
  return (
    <Link href={`/product/${id}`} className="flex flex-col gap-3 font-sans w-full mx-4 max-w-65 group cursor-pointer hover:no-underline active:scale-[0.98] transition-transform duration-200">
      {/* Image Container */}
